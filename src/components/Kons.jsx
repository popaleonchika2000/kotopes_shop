            ...
            <Block2>
                <div id="product-product" class="container">
                    <div class="product-wrapper">
                        <h1>Консервы Royal Canin Adult Beauty для собак всех возрастов и пород (195 гр) </h1>
                    ...
                    <div class="product-image">
                        <div class="main-thumb">
                            <img class="img-responsive" src={konserva} title="Сухой корм WELLNESS CORE из индейки с курицей для котят (Срок годности 26.06.2024)"
                        ...
                        <div class="cart-block">
                            <div class="price-block">
                                <span class="card__price card__price--discount">419,65 ₽</span>
                                <span class="card__price card__price--common">1199 ₽</span>
                            </div>
                    ...
                    <div class="tabs-wrapper">
                        <div class="tab-content">
                            <p>Корм консервированный полнорационный диетический для собак, рекомендуемый при расстройствах пищеварения, в реабилитационный период и при <br />
                                истощении. Ветеринарная диета. <br /> <br />

                                Формула способствует поддержанию здорового пищеварения и оптимального качества стула <br />
                                высокое содержание энергии помогает уменьшить объем порции и снизить нагрузку на пищеварительную систему <br />
                                высокая вкусовая привлекательность стимулирует потребление корма при сниженном аппетите <br /> <br />

                                Показания: <br />
                                Острая и хроническая диарея <br />
                                Гастрит <br />
                                Воспалительные заболевания кишечника (ВЗК) <br />
                                Колит <br />
                                Экзокринная недостаточность поджелудочной железы <br />
                                Чрезмерный рост бактериальной флоры в тонком кишечнике <br />
                                Синдром мальдигестии/мальабсорбции <br />
                                Снижение аппетита, возобновление кормления после операции <br /> <br />

                                Противопоказания: <br />
                                Панкреатит или панкреатит в анамнезе <br />
                                Гиперлипидемия <br />
                                Лимфангиэктазия, экссудативная энтеропатия <br /> <br />

                                РЕКОМЕНДАЦИЯ: решение о продолжительности курса диетотерапии или смене диеты можно принимать только по рекомендации ветеринарного врача. <br /> <br />

                                Продолжительность применения продукта зависит от степени выраженности симптомов со стороны желудочно-кишечного тракта. Для оптимальной <br />
                                работы пищеварительной системы необходимо увеличение кратности кормлений в день.
                            </p>
                        </div>
                    </div>
                </div>
