            ...
            <Block2>
                <div id="product-product" class="container">
                    <div class="product-wrapper">
                        ...
                        <div class="product-model">Код товара: 28381</div>
                        <div class="options-block">
                            <button className="card__btn">Поштучно</button>
                        </div>
                    </div>
                    <div class="product-image">
                        <div class="main-thumb">
                            <img class="img-responsive" src={tabletka} title="Сухой корм WELLNESS CORE из индейки с курицей для котят (Срок годности 26.06.2024)"
                        ...
                        <div class="cart-block">
                            <div class="price-block">
                                <span class="card__price card__price--discount">3244 ₽</span>
                                <span class="card__price card__price--common">5899 ₽</span>
                            </div>
                    ...
                    <div class="tabs-wrapper">
                        <div class="tab-content">
                            <p> <b>Общие сведения</b> <br />
                                Торговое наименование лекарственного препарата: Симпарика (Simparica). <br />
                                Международное непатентованное наименование: сароланер. <br />

                                Лекарственная форма: таблетки для перорального применения. <br />

                                <b>Симпарику выпускают в шести дозировках,</b>  содержащих в 1 таблетке в качестве действующего вещества сароланер 5, 10, 20, 40, 80 и 120 мг, а также <br />
                                вспомогательные вещества: лактозы моногидрат, натрия карбоксиметил-крахмал, кремния диоксид коллоидный, магния стеарат и вкусоароматическую <br />
                                гранулированную основу. <br />
                                <b>По внешнему виду Симпарика представляет собой таблетки квадратной формы</b> с надписью на одной стороне таблетки: «5» (дозировка 5 мг/табл.), «10» <br />
                                (дозировка 10 мг/табл.), «20» (дозировка 20 мг/табл.), «40» (дозировка 40 мг/табл.), «80» (дозировка 80 мг/табл.) или «120» (дозировка 120 мг/табл.),
                                с закругленными <br /> углами, коричневого цвета в крапинку. <br />

                                <b>Срок годности лекарственного препарата при соблюдении условий хранения - 2 года с даты производства. <br />
                                    Запрещается применять Симпарику после истечения срока годности.</b> <br />

                                <b>Симпарику выпускают расфасованной в блистеры</b> по 1, 3 или 6 таблеток. Блистеры упакованы в картонные коробки. В каждую коробку
                                вложена инструкция по <br /> применению на русском языке. <br />

                                <b>Хранят</b> лекарственный препарат в закрытой упаковке производителя, в защищенном от прямых солнечных лучей месте, отдельно от
                                продуктов питания и кормов при <br /> температуре от 2°C до 30°C в местах, недоступных для детей. <br />

                                Неиспользованный лекарственный препарат утилизируют в соответствии с требованиями законодательства. <br />

                                <b>Симпарику отпускают без рецепта ветеринарного врача.</b></p>
                        </div>
                    </div>
                </div>
            </Block2>
